...
- `Prompt_Engineering_Live_Lab_2026.ipynb`: 32-cell synthetic Chief of Staff lab.

## Productivity summary

The general library includes daily productivity, production systems, personal productivity, knowledge management, learning, writing, decision quality and frontier prompting. The Microsoft 365 library covers morning command centre, inbox intelligence, meetings, stakeholder radar, project control tower, calendar and focus, content creation, study, memory, leadership communication, Cowork automation, and career visibility.
